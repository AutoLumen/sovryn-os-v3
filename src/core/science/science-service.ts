...
${trial.launchDecision === "rc_ready" ? "Sovryn can be treated as 3.5.0-rc.1 ready for the bounded autonomous computational-science scope represented by this deterministic trial." : "Sovryn should remain blocked from RC promotion until the listed blockers are resolved."}
