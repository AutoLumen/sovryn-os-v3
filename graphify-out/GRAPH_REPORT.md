...
## Corpus Check
- 159 files · ~634,808 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2954 nodes · 9710 edges · 45 communities detected
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 1961 edges (avg confidence: 0.8)
...
1. `writeJson()` - 407 edges
2. `nowIso()` - 309 edges
3. `hashEvidence()` - 197 edges
4. `executeCli()` - 145 edges
...
Cohesion: 0.02
Nodes (200): assertRejected(), candidate(), makeResultRoot(), makeTargetCorpusRepo(), policy(), writeCorpusResult(), writeExternalResult(), writeResultFiles() (+192 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (88): looksLikeNetworkCommand(), networkDenyEnv(), runCommand(), configExists(), configPath(), ensureGitignore(), initConfig(), loadConfig() (+80 more)
...
Cohesion: 0.02
Nodes (100): factoryPriorArtFixtures(), factorySourceReadingFixtures(), patentSourceReadingFixture(), withReadingHash(), ArxivSearchAdapter, asArray(), asRecord(), boolOrDefault() (+92 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (83): averageEvidenceStrength(), buildBenchmarkPlan(), buildCandidateInventions(), buildClaimElementMap(), buildCounterEvidence(), buildExperimentPlan(), buildFactoryScore(), buildFactorySourceReadings() (+75 more)
...
Cohesion: 0.09
Nodes (25): commandSummary(), patchAuditorScript(), patchAuditorTest(), patchDataset(), PatchRiskAuditorResearchService, renderHumanReviewChecklist(), renderPilotReport(), renderPublicReadme() (+17 more)
...
Cohesion: 0.11
Nodes (17): campaignGates(), clampInt(), countKinds(), FailingRealSourceFixtureAdapter, fixtureConcreteSources(), fixtureFallbackSources(), numberValue(), RealSourceExternalCampaignService (+9 more)
...
- **Why does `hashEvidence()` connect `Community 6` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Are the 406 inferred relationships involving `writeJson()` (e.g. with `makeTargetRepo()` and `writeResult()`) actually correct?**
  _`writeJson()` has 406 INFERRED edges - model-reasoned connections that need verification._
- **Are the 308 inferred relationships involving `nowIso()` (e.g. with `.check()` and `.demo()`) actually correct?**
  _`nowIso()` has 308 INFERRED edges - model-reasoned connections that need verification._
- **Are the 195 inferred relationships involving `hashEvidence()` (e.g. with `replacePriorArtEvidence()` and `replaceSourceReadingsEvidence()`) actually correct?**
  _`hashEvidence()` has 195 INFERRED edges - model-reasoned connections that need verification._
- **Are the 96 inferred relationships involving `executeCli()` (e.g. with `createPublicBetaFixture()` and `createStrictRunWithoutSharedState()`) actually correct?**
  _`executeCli()` has 96 INFERRED edges - model-reasoned connections that need verification._