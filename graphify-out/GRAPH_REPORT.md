...
## Corpus Check
- 53 files · ~55,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 343 nodes · 900 edges · 15 communities detected
...
Cohesion: 0.09
Nodes (23): configPath(), ensureGitignore(), initConfig(), readText(), discoverVerifyCommands(), exists(), readPackageJson(), appendLesson() (+15 more)
...
Cohesion: 0.07
Nodes (20): AppError, writeEvent(), createMissionId(), exists(), slugify(), titleFromBrief(), listArtifactFiles(), nonEmpty() (+12 more)

### Community 3 - "Community 3"
Cohesion: 0.12
Nodes (10): commandOutput(), createResearchPlan(), LocalNodeAlphaBackend, planStep(), shellQuote(), writeFileCommand(), backendForHost(), NodeManager (+2 more)
...
Cohesion: 0.13
Nodes (11): looksLikeNetworkCommand(), networkDenyEnv(), runCommand(), countLines(), GitAdapter, listFiles(), numstat(), shellQuote() (+3 more)
...
- **Why does `nowIso()` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `executeCli()` connect `Community 5` to `Community 8`, `Community 1`, `Community 4`, `Community 9`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `PostgresStore` connect `Community 10` to `Community 0`?**
